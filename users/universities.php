           ...
           <h4 Style = "color : rgb(139,26 , 184)">الخطة الدراسية</h4>
            ...
            <a Style = "color : rgb(22, 70, 243)" href="https://cces.psau.edu.sa/psau/acedemicprogram/54/2259/4" target="_blank"><h4>اضغط هُنا</a></p></h4>
             ...
             <h3 dir="rtl" >جامعة شقراء</h3>
              <h4 dir="rtl">(%الثانوية العامة 40% ,القدرات العامة 30% ,التحصيلي 30 )</h4>
...
<h4>بقية التخصصات </h4>
 <br>
 <h4 dir="rtl" >(%الثانوية العامة 60% ,القدرات العامة 40  )</h4>
             <br>
             <h4 Style = "color : rgb(139,26 , 184)">الخطة الدراسية</h4>
            ...
            <h4> المسار العلمي </h4>
<br>
             <h4 dir="rtl" >(%الثانوية العامة 40% ,القدرات العامة 40% ,التحصيلي 20 )</h4>
             <br>
 <h4> المسارالأدبي/طلاب </h4>
<br>
             <h4 dir="rtl" >(%الثانوية العامة 50% ,القدرات العامة 50 )</h4>
             <br>
...
<h4>بقية التخصصات </h4>
 ...
 <h4 dir="rtl" >(%الثانوية العامة 60% ,القدرات العامة 40  )</h4>
             <br>
                 ...
                 <h4 dir="rtl" >(%الثانوية العامة 30% ,القدرات العامة 30% ,التحصيلي 40 )</h4>
                 <br>
                 <h4 Style = "color : rgb(139,26 , 184)">الخطة الدراسية</h4>
...
<h4>الطلاب</h4>
                 ...
                 <br>
<h4>الطالبات</h4>
(%الثانوية العامة 30% ,القدرات العامة 50% ,التحصيلي 20 )
<br>
                 <h4 Style = "color : rgb(139,26 , 184)">الخطة الدراسية</h4>
