  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"> حذف مستخدم (<?php echo $user['name']; ?>)</h4>
            ...
            <div class="col-md-12">
              <div class="form-group">
                <div class="alert alert-info">
                  ...
                  <p class="text-left">جميع المستندات والملفات المرتبطة بهذه العضوية ستبقى في خزينة النظام، حتى تقوم بربطها بعضوية أخرى.</p>
                </div>
              </div>
              <div class="form-group">
                <div class="alert alert-danger">
                  هل أنت متأكد من رغبتك في حذف العضوية الحالية بشكلٍ نهائي؟
                </div>
              </div>
