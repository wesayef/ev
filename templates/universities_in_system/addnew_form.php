<a data-toggle="modal" role="button" href="#add_new" class="btn btn-right-icon btn-success"><i class="fa fa-plus"></i> إضافة جامعة جديدة </a>
<div id="add_new" class="modal fade"  role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"> إضافة جامعة جديدة </h4>
      ...
      <form method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="modal-body with-padding">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <textarea name="about" class="form-control" style="height:50px"></textarea>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" name="high_school" class="form-control percentage-inputmask">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-2 col-form-label">القدرات</label>
            <div class="col-sm-10">
              <input type="text" name="general_aptitude" class="form-control percentage-inputmask">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-2 col-form-label">التحصيلي</label>
            <div class="col-sm-10">
              <input type="text" name="scholastic_chievement" class="form-control percentage-inputmask">
            </div>
          </div>
          <h3>* إدراج التخصصات</h3>
