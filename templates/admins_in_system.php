  ...
  <div class="container-fluid">
    <div class="row page-titles">
      <div class="col-md-8 col-12 align-self-center">
        <h3 class="text-themecolor mb-0 mt-0"> مشرفين النظام</h3>
      </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            include_once 'admins_in_system/addnew_form.php';
            echo "<hr>";
            if($conn->getReference('admins/')->getSnapshot()->numChildren() == 0)
            {
              echo '
            ...
            else
            {
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <table class="table table-bordered tables_mobile">
                  ...
                  <tbody>
                    ...
                    foreach ($conn->getReference('admins/')->getSnapshot()->getValue() as $key => $user){
                      ...
                      <td class="text-center" data-title="اسم المستخدم"><?php echo $user['username']; ?></td>
                      <td class="text-center" data-title="الاسم"><?php echo $user['name']; ?></td>
                ...
                foreach ($conn->getReference('admins/')->getSnapshot()->getValue() as $key => $user){
                  include 'admins_in_system/delete_form.php';
                  include 'admins_in_system/edit_form.php';
                }
                ?>
              </div>
            <?php } ?>
