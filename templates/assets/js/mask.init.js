    ...
    $(".date-inputmask").inputmask("dd/mm/yyyy"),
     $(".phone-inputmask").inputmask("999999999");
        ...
        $(".currency-inputmask").inputmask({
             mask: "*{1,20}[.*{1,20}][.*{1,20}][.*{1,20}] ريال سعودي"
            , greedy: !1
            , onBeforePaste: function (n, a) {
                return (e = e.toLowerCase()).replace("mailto:", "")
            }
        ...
        $(".shelf_quantity-inputmask").inputmask({
             mask: "*{1,20}[.*{1,20}][.*{1,20}][.*{1,20}] منتج "
            , greedy: !1
            , onBeforePaste: function (n, a) {
                return (e = e.toLowerCase()).replace("mailto:", "")
            }
        ...
        $(".emaildomain-inputmask").inputmask({
            mask: "*{1,20}[.*{1,20}][.*{1,20}][.*{1,20}]@dkakkne.sa"
            , greedy: !1
            , onBeforePaste: function (n, a) {
                return (e = e.toLowerCase()).replace("mailto:", "")
            }
